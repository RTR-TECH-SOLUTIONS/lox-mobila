...
export const projects: Project[] = [
  ...
  {
    slug: 'bucatarie-insula-valea-lupului',
    title: 'Bucătărie cu insulă',
    category: 'bucatarii',
    district: 'Valea Lupului',
    weeks: 6,
    featured: true,
  ...
  {
    slug: 'bucatarie-liniara-nicolina',
  ...
  {
    slug: 'living-biblioteca-tatarasi',
  ...
  {
    slug: 'living-comoda-valea-lupului',
